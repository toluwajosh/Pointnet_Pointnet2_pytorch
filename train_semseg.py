...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str,
                        default='pointnet2', help='Name of model')
...
def main(args):
    ...
    file_dir = Path(str(experiment_dir) + '/%sSemSeg-' % args.model_name +
    ...
    model = PointNet2SemSeg(num_classes) if args.model_name == 'pointnet2' else PointNetSeg(
    ...
    for epoch in range(init_epoch, args.epoch):
        ...
        test_metrics, test_hist_acc, cat_mean_iou = test_semseg(model.eval(
        ), testdataloader, seg_label_to_cat, num_classes=num_classes, pointnet2=pointnet2)
        ...
        if test_metrics['accuracy'] > best_acc:
            ...
            torch.save(model.state_dict(), '%s/%s_%.3d_%.4f.pth' %
